                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('article.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                <input type="text" value="{{ old('title')}}" placeholder="Enter Title" id="title" name="title"
                            ...
                            <div class="mb-3">
                                <textarea placeholder="Content" name="text" id="text" placeholder="Enter Content" class="border border-gray-300 w-1/2 rounded-lg">{{ old('text')}}</textarea>
                                    @error('text')
                                            <p class="text-red-400 font-medium">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <input type="text" value="{{ old('author')}}" placeholder="Enter Author" id="author" name="author"
                                    class="border border-gray-300 w-1/2 rounded-lg" />
                                    @error('author')
                                            <p class="text-red-400 font-medium">{{$message}}</p>
                                    @enderror
